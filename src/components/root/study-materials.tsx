import "../globals.css";
import { House,   LogOut, NotebookPen, ChevronDown, ChevronRight, FileText, Plus, Menu, Calendar} from "lucide-react"
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-blue-950">Add New Subject</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <DialogFooter>
          <Button type="submit" className="flex items-start">Add Subject</Button>
          <DialogClose asChild>
...
function AddUnitDialog({ onAddUnit }: { onAddUnit: (name: string, file: File) => void }) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-black text-center" >Add New Unit</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <Label htmlFor="unitName" className="text-black">Unit Name</Label>
            <Input
              id="unitName"
              value={unitName}
          ...
          <div>
            <Label htmlFor="pdfFile" className="text-black">PDF File</Label>
            <Input
              id="pdfFile"
              type="file"
              accept=".pdf"
